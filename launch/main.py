...
def main():
    ...
    parser.add_argument(
        '-build', '--build', help='Create new work environment/launch file', type=str, metavar='')

    parser.add_argument(
        '-a', '--add', help='Add program to existing launch file', type=str, metavar='')

    parser.add_argument(
        '-sh', '--show', help='Show all program in launch file', type=str, metavar='')

    parser.add_argument(
        '-t', '--time', help='Time in seconds between execution', type=int, metavar='')

    parser.add_argument('-e', '--exclude',
                        help='Run program except', type=str, metavar='')

    parser.add_argument('-remove', '--remove',
                        help='Remove program from given launch file', type=str, metavar='')

    parser.add_argument(
        '-run', '--run', help='Run environment', type=str, metavar='')

    parser.add_argument(
        '-ls', '--list', help='List all available launch file', action='store_true')

    parser.add_argument(
        '-purge', '--purge', help='delete the work launch file', type=str, metavar='')
